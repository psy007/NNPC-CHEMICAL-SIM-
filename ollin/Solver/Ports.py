...
import re, string
from numpy import array, float64, zeros, ones
import numpy as np 
...
class Port(object):
    ...
    def CloneContents(self, clone):
        ...
        clone._estimated = self._estimated1
...
class Port_Material(Port):
    ...
    def __init__(self, portType, parentOp, name=''):
        ...
        """
        Port.__init__(self, portType, parentOp, name)   # Prabhat Port.__init__(self)
    ...
    def GetNuKnownprops(self, type=None):  # Prabhat has defined
        """Number of properties with calcStatus != UNKNOWN_V"""
        return super(Port_Material, self).GetKnownprops(type)
    ...
    def SetCompositionValues(self, vals, calcStatus):
        ...
        vals -- List of np values of composition
    ...
    def CalcFlows(self, calcStatus=CALCULATED_V):
        ...
        if None in (moles, massFlow, volFlow, stdVolFlow, q, stdGasVolFlow): # style changed by prabhat

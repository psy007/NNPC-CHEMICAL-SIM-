...
Ollin.Resumen("S1")
print("############## S1 has been solved...")
print S1.Get("H")
print(S1.Get("x"))

S2=Ollin.AddCase("S2")#salida del compresor
S2.SetX(S1.Get("x"))
print("From S2 SetX() is OK")
S2.H(S1.Get("H")) #Considerando que es adiabatico dQ=0
print("From S2 Hentalpy is OK")
S2.P(101.325*20)
print("From S2 Pressure is OK")
Ollin.Solve("S2")#Caculamos S2
Ollin.Resumen("S2")
print("############## S2 has been solved...")
#

...
class ThermoObj:
    ...
    def __init__(self):
        ...
        self.Vars = ("P","T","Mol_WT","FracVap","Z","Zv","Zl","CpG","CpL","H","Hv","CoeFugOl","CoeFugOv","CoeFugOl",
                     "CoeFugMl","CoeFugMl","yf","xf","Pvi","Ki","fi","Zi","Zli","Zvi")
        self.EOSVars = {}
        self.Prop = {}
        self.ExtProp = {}
        self.Prop["P"] = None  # P is Pressure Kpa
        self.IdP = 0
        self.Prop["T"] = None  # T is temperature and it in kelvin
        self.IdT = 0
        ...
        self.Solve = 0
        self.Model = None
        self.Prop["x"] = None  # x - mole fraction of the mixture
        self.Prop["xf"] = None
        self.Prop["yf"] = None
##      self.Name = str(self)
    ...
    def FracVap(self,Frac): #needed
        """
        Set Fraction Vapor
        """
        print("FracVap is being called")
        self.IdF = 1
        if self.Prop["FracVap"] != Frac:
            #print("Ja raha hai bhai")
    ...
    def SetX(self, Xt):
        '''
        :param Xt: It is a list as [xi,..]
        :return: Set mole fraction (x) for each element in a Mixture (say: ["METHANE","ETHANE","PROPANE","ISOBUTANE",
        "N-BUTANE", ...... ])
        '''
    ...
    def Get(self,Var):
        #print("self.Prop.keys()",self.Prop.keys())
    ...
    def CasePrint(self):
        ...
        print "Pressure  KPa   = %.3f" %self.Prop["P"]
        print "Temperature   K     = %.3f" %self.Prop["T"]
